...
function c99970500.initial_effect(c)
  ...
  e1:SetCountLimit(1,99970500)
  e1:SetTarget(c99970500.thtg)
  e1:SetOperation(c99970500.thop)
  c:RegisterEffect(e1)
  local e2=e1:Clone()
  ...
  e4:SetDescription(aux.Stringid(99970500,1))
  e4:SetCategory(CATEGORY_SPECIAL_SUMMON)
  e4:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
  e4:SetCode(EVENT_CHAIN_SOLVED)
  e4:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DAMAGE_CAL)
  e4:SetRange(LOCATION_MZONE)
  e4:SetCondition(c99970500.spcon)
  e4:SetCost(c99970500.spcost)
  e4:SetTarget(c99970500.sptg)
  e4:SetOperation(c99970500.spop)
  c:RegisterEffect(e4)
end
c99970500.listed_namescount=1
c99970500.listed_names={99970510}
--(1) Search
...
function c99970500.spfilter(c,e,tp)
  return c:IsCode(99970510) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
