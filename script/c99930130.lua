...
function c99930130.initial_effect(c)
  c:EnableReviveLimit()
  --Xyz Summon
  aux.AddXyzProcedure(c,c99930130.xyzfilter,nil,99,c99930130.ovfilter,aux.Stringid(99930130,1),nil,nil,false,c99930130.xyzcheck)
...
function c99930130.xyzcheck(g,tp,xyz)
