...
function c99930040.initial_effect(c)
  c:EnableReviveLimit()
  --Xyz Summon
  aux.AddXyzProcedure(c,c99930040.xyzfilter,nil,99,c99930040.ovfilter,aux.Stringid(99930040,1),nil,nil,false,c99930040.xyzcheck)
...
function c99930040.xyzcheck(g,tp,xyz)
