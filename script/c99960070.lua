...
function c99960070.initial_effect(c)
  c:EnableReviveLimit()
  --Xyz Summon 
  aux.AddXyzProcedure(c,c99960070.xyzfilter,nil,99,c99960070.ovfilter,aux.Stringid(99960070,0),nil,c99960070.xyzop,false,c99960070.xyzcheck)
  --(1) Attach
...
function c99960070.xyzcheck(g,tp,xyz)
